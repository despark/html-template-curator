...
(function($)
{
	...
	Redactor.fn = $.Redactor.prototype = {
		...
		cleanUnverified: function()
		{
			...
			var $elem = this.$editor.find('li, img, video, a, b, strong, sub, sup, i, em, u, small, strike, del, span, cite');
		...
		{
			this.$editor.find('a:not(.in-app-link)').on('click', $.proxy(this.linkObserver, this));
		...
		imageResizeControls: function($image)
		{
			...
			// resizer
			if (this.opts.imageResizable && ! $image.hasClass('video-thumb'))
			{
